...
class Botutils(commands.Cog):
    ...
    @commands.command(name='moveusto')
    ...
    @commands.command(name='emojiinf')
    @commands.guild_only()
    ...
    @commands.command(name='usersinfo')
    @commands.guild_only()
    ...
    @commands.command(name='channelinf')
    @commands.guild_only()

...
class MoreAdmin(commands.Cog):
    ...
    @commands.guild_only()
    async def says(self, ctx, *, content: str):
    ...
    @commands.guild_only()
    @checks.admin_or_permissions(administrator=True)
    async def sends(self, ctx, channel: discord.TextChannel, *, msg: str):
        """
    ...
    @commands.guild_only()
    @checks.admin_or_permissions(administrator=True)
    async def reacts(self, ctx, channel: discord.TextChannel, message_id: int, emoji: Union[discord.Emoji, str]):
        """
